...
export class CodeBit {
    ...
    // identical to generate but meant to create final version of the file, requires all variables injected
    finalize() {
...
// Given a vector of vectors of words, print out all combinations of one word from the first vector,
// one from the second vector, etc.
